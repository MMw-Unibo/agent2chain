...
prepareTransaction = _load_tool_function("prepareTransaction.py", "prepareTransaction")
interactWithContract = _load_tool_function("interactWithContract.py", "interactWithContract")

load_dotenv()

ADK_TOOLS = [
    FunctionTool(prepareTransaction),
    FunctionTool(interactWithContract),
]
ADK_TOOLS_BY_NAME = {tool.name: tool for tool in ADK_TOOLS}

_log("Creating MCP Server instance...")
app = Server("MetaMaskToolsServer")
