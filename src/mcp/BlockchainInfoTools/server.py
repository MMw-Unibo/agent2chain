...
getGasPrice = _load_tool_function("getGasPrice.py", "getGasPrice")
getPrice = _load_tool_function("getPrice.py", "getPrice")
getRates = _load_tool_function("getRates.py", "getRates")
getTVL = _load_tool_function("getTVL.py", "getTVL")
getTransactionDetails = _load_tool_function("getTransactionDetails.py", "getTransactionDetails")
getTransactions = _load_tool_function("getTransactions.py", "getTransactions")

load_dotenv()

ADK_TOOLS = [
    FunctionTool(getGasPrice),
    FunctionTool(getPrice),
    FunctionTool(getRates),
    FunctionTool(getTVL),
    FunctionTool(getTransactionDetails),
    FunctionTool(getTransactions),
]
ADK_TOOLS_BY_NAME = {tool.name: tool for tool in ADK_TOOLS}

_log("Creating MCP Server instance...")
app = Server("BlockchainInfoToolsServer")
